    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <section className="container mx-auto px-6 py-16 md:py-24 text-center flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-brand-red hover:bg-brand-darkred text-white shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              <Link href="/register">Become a Donor Today</Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 bg-card hover:bg-muted">
        ...
        <section className="bg-card py-16 md:py-20 border-t border-b">
            <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div className="p-6">
                   ...
                   <p className="text-muted-foreground">Our intelligent algorithms rank donors based on compatibility, reliability, and proximity.</p>
                </div>
                 <div className="p-6">
                   ...
                   <p className="text-muted-foreground">Bridging the gap between hospitals, donors, and those in need efficiently.</p>
                </div>
                 <div className="p-6">
                   ...
                   <p className="text-muted-foreground">Join a network of lifesavers and make a real difference in your community.</p>
                </div>
            </div>
        </section>
      </main>
      ...
      <footer className="py-6 bg-muted/50 border-t">
          <div className="container mx-auto px-6 text-center text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} Smart Blood Platform. Powered by AI for a healthier tomorrow.
          </div>
      </footer>
    </div>
  );
